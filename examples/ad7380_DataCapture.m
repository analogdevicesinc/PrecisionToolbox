%% Script for capturing and displaying a continuous set of samples from a connected AD7380 board

%% Trigger setup needs to be performed before this example script can be run
%% Refer to the Limitations section in the documentation for details on the process. 
